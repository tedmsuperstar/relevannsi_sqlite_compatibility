...
add_filter('relevanssi_indexing_values', 'handle_relevanssi_queries', 10, 2);
add_filter('relevanssi_fuzzy_query', 'handle_relevanssi_queries', 10, 2);


function handle_relevanssi_queries($values, $post ){
